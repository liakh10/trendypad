...
if (process.argv.includes('--memory')) process.env.TRENDY_MEMORY = '1';
...
}).listen(Number(process.env.PORT || 8795), () => console.log('trendypad dev on', process.env.PORT || 8795));
